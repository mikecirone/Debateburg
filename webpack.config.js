...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      createItemLogContainer: 'client/containers/createItemLogContainer.jsx',
      ItemMaker: 'client/components/ItemMaker.jsx',
      createItemMakerContainer: 'client/containers/createItemMakerContainer.jsx',
      ItemsActions: 'client/actions/ItemsActions.jsx',
      ItemsReducer: 'client/reducers/ItemsReducer.jsx',
